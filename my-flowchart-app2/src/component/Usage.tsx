    ...
    <div>
      ...
      <div className="usage-box">
        <ol>
          ...
          <li>Next, create a Process or Branch Node from Start Node. Hovering a Node, some icons are displayed. Each icon has the following role.</li>
          <li><AiOutlinePlusCircle></AiOutlinePlusCircle> is to create a new Process or Branch Node.</li>
          ...
          <li>As an option, try to drag and drop from a Node to other. They are connected. This is useful that you want to delete Nodes among flowchart or connect to another Node.</li>
