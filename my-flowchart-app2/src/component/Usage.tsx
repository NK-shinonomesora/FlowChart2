  ...
  return (
    ...
    <div>
      ...
      <div className="usage-box">
        <ol>
          <li>Starting this app, you are in the Title Page and see the all saved titles of flowchart.</li>
          <li>Clicking a title-box, you can confirm and update the flowchart. A trash-icon deletes it.</li>
          ...
          <li>As an option, try to drag and drop from a Node to others. They are connected. This is useful that you want to delete Nodes among flowchart or connect to a previous Node.</li>
